...
class EmployeeResource(resources.ModelResource):
    ...
    class Meta:
        model = Employee
        fields = ('id', 'user', 'services', 'joining_date', 'is_active','is_available', 'created_at', 'updated_at')
        export_order = ('id', 'user', 'services', 'joining_date', 'is_active', 'is_available','created_at', 'updated_at')
...
class BookingResource(resources.ModelResource):
    ...
    class Meta:
        model = Booking
        fields = ('id', 'user', 'service', 'employee', 'scheduled_date', 'status', 'notes', 'created_at', 'updated_at')
        export_order = ('id', 'user', 'service', 'employee', 'scheduled_date', 'status', 'notes', 'created_at', 'updated_at')